...
mod tests {
    ...
    fn test_app_state() {
        ...
        // Testing of fields
        assert_eq!(app_state.debug, DEBUG);
        assert_eq!(app_state.app_name, "Example".to_string());
        assert_eq!(app_state.media_url, "/media/".to_string());
        assert_eq!(app_state.media_root, "./media/".to_string());
        assert_eq!(app_state.static_url, "/static/".to_string());
        assert_eq!(app_state.static_root, "./static/".to_string());
        assert_eq!(app_state.templates, "./templates/".to_string());
        // Testing of methods
